...
Kag_graph = pickle.load(open('./lattice_files_v1/Kag_graph_periodic.pickle', 'rb'))


#folder_base = "../data_prathus_runs/APQ1/"
#Jmax = 0.66
folder_base = "../../data_prathus_runs/"
all_folders = [folder_base + "periodic Kagome fwd2/", folder_base + "periodic Kagome fwd3/", folder_base + "periodic Kagome fwd4/", folder_base + "periodic Kagome fwd5/"]
# Jmax = 0.66
allJvals = [0.66, 0.83, 1.0, 1.4]

# folder_global = folder_base + "raw"

where_to_save = folder_base + "processed_FT/"
...
for mf in range(len(all_folders)):
    ...
    #sample among only Nreads of them
    Nreads = 200
